    ...
    return (
        <div className='dashboard'>
            <div className="taskToDoCard">
                ...
                <div>
                    <p>
                        Welcome to our Library Manager App, designed to streamline your productivity and keep your tasks organized. With a simple interface and intuitive features, managing your daily task has never been easier.
                    </p>
                    <b>Main Features:</b>
                    <p>
